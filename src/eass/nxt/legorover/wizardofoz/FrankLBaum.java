...
public class FrankLBaum extends JPanel implements ActionListener, WindowListener, PropertyChangeListener {
	    ...
	    protected JButton fbutton, rbutton, lbutton, sbutton, delaybutton, r90button, l90button, bbutton, line;
	    ...
	    protected String[] actions = {"do_nothing", "stop", "backward10", "right90", "left90", "forward", "forward10", "follow_line"};
	    ...
	    public FrankLBaum(GridBagLayout layout) {
	        ...
	        // Left 90
	        line = new JButton("Follow YBR");
	        line.setActionCommand("follow_line");
	        line.addActionListener(this);
	        line.setToolTipText("Click to Follow the Yellow Brick Road");
	        c.gridx = 3;
	        c.gridy = 1;
	        controls.add(line, c);
	    	...
	    	if (env.getRobot(rName) instanceof TheLandOfOz.Karen) {
	    		// Obstacle Distance
